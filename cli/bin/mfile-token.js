...
program
    .usage("-u your-mfile-user-name -p your-personal-token")
    .option('-u, --username', 'your mfile user name')
...
program.on('--help', function () {
    ...
    log.tips("    $ mfile token -u your-mfile-user-name -p your-personal-token");
    log.tips();
...
function setToken() {
    ...
    let binPath = utils.mfileBinPath();
